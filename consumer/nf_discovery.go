...
func SendSearchNFInstances(nrfUri string, targetNfType, requestNfType models.NfType,
	param *Nnrf_NFDiscovery.SearchNFInstancesParamOpts, ctx context.Context,
) (models.SearchResult, error) {
	if amf_context.AMF_Self().EnableNrfCaching {
		return nrfCache.SearchNFInstances(nrfUri, targetNfType, requestNfType, param, ctx)
	} else {
		return SendNfDiscoveryToNrf(nrfUri, targetNfType, requestNfType, param, ctx)
	}
}
...
func SearchUdmSdmInstance(ue *amf_context.AmfUe, nrfUri string, targetNfType, requestNfType models.NfType,
	...
	resp, localErr := SendSearchNFInstances(nrfUri, targetNfType, requestNfType, param, ctx)
	if localErr != nil {
		return localErr
	}
