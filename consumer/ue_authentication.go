...
func SendAuth5gAkaConfirmRequest(ue *amf_context.AmfUe, resStar string, ctx context.Context) (
...
func SendEapAuthConfirmRequest(ue *amf_context.AmfUe, eapMsg nasType.EAPMessage, ctx context.Context) (
